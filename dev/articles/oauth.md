...
reg_resp
#> Response [http://127.0.0.1:33911/register?name=3P%20app&redirect_uri=http://127.0.0.1:40007/login/redirect]
#>   Date: 2026-06-06 21:53
#>   Status: 200
...
#> $client_id
#> $client_id[[1]]
#> [1] "id-f3c4fb8f7560851670e12044e676c5"
#> 
#> 
#> $client_secret
#> $client_secret[[1]]
#> [1] "secret-b4553b9ecefbd99e0a66c53fe1655f"
#> 
#> 
#> $redirect_uri
#> $redirect_uri[[1]]
#> [1] "http://127.0.0.1:40007/login/redirect"
```
...
#> Response [http://127.0.0.1:40007/login/config]
#>   Date: 2026-06-06 21:53
#>   Status: 200
#>   Content-Type: application/json
#>   Size: 41 B
...
reg_resp2
#> Response [http://127.0.0.1:33911/register?name=3P%20app2&redirect_uri=http://127.0.0.1:38075/login/redirect]
#>   Date: 2026-06-06 21:53
#>   Status: 200
#>   Content-Type: application/json
#>   Size: 185 B
...
#> $client_id
#> $client_id[[1]]
#> [1] "id-924c8808ef1ac47c2a1c7b7e7f3bfb"
#> 
#> 
#> $client_secret
#> $client_secret[[1]]
#> [1] "secret-a9a220c6a4d320a9b7852e986c6298"
#> 
#> 
#> $redirect_uri
#> $redirect_uri[[1]]
#> [1] "http://127.0.0.1:38075/login/redirect"
auth_data2 <- list(
  auth_url = auth_url,
  token_url = toke_url,
...
#> Response [http://127.0.0.1:38075/login/config]
#>   Date: 2026-06-06 21:53
#>   Status: 200
#>   Content-Type: application/json
#>   Size: 41 B
...
resp_data
#> Response [http://127.0.0.1:38075/data]
#>   Date: 2026-06-06 21:53
#>   Status: 200
#>   Content-Type: application/json
#>   Size: 24 B
...
reg_resp3
#> Response [http://127.0.0.1:33911/register?name=3P%20app2&redirect_uri=http://localhost:1410/]
#>   Date: 2026-06-06 21:53
#>   Status: 200
#>   Content-Type: application/json
#>   Size: 170 B
...
#> $client_id
#> $client_id[[1]]
#> [1] "id-8b466eddb31de40ec74c3cde3798f3"
#> 
#> 
#> $client_secret
#> $client_secret[[1]]
#> [1] "secret-7010a4214986854efa3323dc666a92"
#> 
#> 
#> $redirect_uri
#> $redirect_uri[[1]]
...
#> <Token>
#> <oauth_endpoint>
#>  authorize: http://127.0.0.1:33911/authorize
#>  access:    http://127.0.0.1:33911/token
#> <oauth_app> 3P app2
#>   key:    id-8b466eddb31de40ec74c3cde3798f3
#>   secret: <hidden>
...
#> Response [http://127.0.0.1:33911/data]
#>   Date: 2026-06-06 21:53
#>   Status: 401
...
testthat::test_that("gh_repos", {
  ...
  fake_app$get("/user/repos", function(req, res) {
    if (!fake_app$is_authorized(req, res)) return()
    res$send_json(list(
