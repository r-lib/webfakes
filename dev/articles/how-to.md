...
#> Response [http://127.0.0.1:40859/unstable]
...
post_package("vcr")
#> Response [http://127.0.0.1:32811/packages?name=vcr]
#>   Date: 2026-05-15 10:04
#>   Status: 200
#>   Content-Type: application/json
#>   Size: 18 B
...
#> Response [http://127.0.0.1:32811/packages?name=httptest]
#>   Date: 2026-05-15 10:04
#>   Status: 200
#>   Content-Type: application/json
#>   Size: 29 B
...
#>      0.000000      0.000026      0.000125      0.000153      0.007254 
#>         total 
#>      2.007482
```
