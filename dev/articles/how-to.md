...
#> Response [http://127.0.0.1:36905/unstable]
...
post_package("vcr")
#> Response [http://127.0.0.1:42531/packages?name=vcr]
#>   Date: 2026-05-15 08:48
#>   Status: 200
#>   Content-Type: application/json
#>   Size: 18 B
...
#> Response [http://127.0.0.1:42531/packages?name=httptest]
#>   Date: 2026-05-15 08:48
#>   Status: 200
#>   Content-Type: application/json
#>   Size: 29 B
...
#>      0.000000      0.000028      0.000136      0.000192      0.008160 
#>         total 
#>      2.008706
```
