...
#> Response [http://127.0.0.1:41775/unstable]
...
post_package("vcr")
#> Response [http://127.0.0.1:34015/packages?name=vcr]
#>   Date: 2026-05-15 10:28
#>   Status: 200
#>   Content-Type: application/json
#>   Size: 18 B
...
#> Response [http://127.0.0.1:34015/packages?name=httptest]
#>   Date: 2026-05-15 10:28
#>   Status: 200
#>   Content-Type: application/json
#>   Size: 29 B
...
#>      0.000000      0.000034      0.000164      0.000203      0.008460 
#>         total 
#>      2.008863
```
