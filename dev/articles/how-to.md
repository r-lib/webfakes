...
#> Response [http://127.0.0.1:35959/unstable]
...
post_package("vcr")
#> Response [http://127.0.0.1:43937/packages?name=vcr]
#>   Date: 2026-05-15 09:50
#>   Status: 200
#>   Content-Type: application/json
#>   Size: 18 B
...
#> Response [http://127.0.0.1:43937/packages?name=httptest]
#>   Date: 2026-05-15 09:50
#>   Status: 200
#>   Content-Type: application/json
#>   Size: 29 B
...
#>      0.000000      0.000024      0.000116      0.000141      0.006911 
#>         total 
#>      2.007357
```
