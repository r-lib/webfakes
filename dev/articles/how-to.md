...
#> Response [http://127.0.0.1:33781/unstable]
...
post_package("vcr")
#> Response [http://127.0.0.1:38577/packages?name=vcr]
#>   Date: 2026-05-15 09:08
#>   Status: 200
#>   Content-Type: application/json
#>   Size: 18 B
...
#> Response [http://127.0.0.1:38577/packages?name=httptest]
#>   Date: 2026-05-15 09:08
#>   Status: 200
#>   Content-Type: application/json
#>   Size: 29 B
...
#>      0.000000      0.000026      0.000144      0.000209      0.007548 
#>         total 
#>      2.007991
```
