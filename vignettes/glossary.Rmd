...
You can start an app with its `$listen()` method.
...
Routing is the process of going over the handler stack, and calling handler functions, one after the other, until one handles the request.
