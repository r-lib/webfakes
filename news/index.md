...
- New [`git_app()`](https://webfakes.r-lib.org/reference/git_app.md) app
  to fake a git HTTP server. See the webfakes test cases for examples.

- New [`mw_cgi()`](https://webfakes.r-lib.org/reference/mw_cgi.md)
  middleware to call CGI scripts. See the new
  [`git_app()`](https://webfakes.r-lib.org/reference/git_app.md) for an
  example.
...
- [`tmpl_glue()`](https://webfakes.r-lib.org/reference/tmpl_glue.md) now
  works correctly on platforms with an issue in
...
- New utility function
  [`http_time_stamp()`](https://webfakes.r-lib.org/reference/http_time_stamp.md)
...
- [`mw_etag()`](https://webfakes.r-lib.org/reference/mw_etag.md) now
