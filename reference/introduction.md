...
- You can use the built-in
  [`webfakes::httpbin_app()`](https://webfakes.r-lib.org/reference/httpbin_app.md)
  app, so it is easy to switch from httpbin.org.

- You can write your custom app, httpbin.org might not have what you
  need.

### Using [`webfakes::httpbin_app()`](https://webfakes.r-lib.org/reference/httpbin_app.md) with testthat
...
test case. See
[`vignette("how-to")`](https://webfakes.r-lib.org/articles/how-to.md)
for details how.
