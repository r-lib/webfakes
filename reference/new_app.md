...
- [`mw_etag()`](https://webfakes.r-lib.org/reference/mw_etag.md) adds an
  `ETag` header to the response.

- [`mw_json()`](https://webfakes.r-lib.org/reference/mw_json.md) parses
  JSON request bodies.

- [`mw_log()`](https://webfakes.r-lib.org/reference/mw_log.md) logs each
  requests to standard output, or another connection.
...
- [`mw_raw()`](https://webfakes.r-lib.org/reference/mw_raw.md) parses
  raw request bodies.

- [`mw_static()`](https://webfakes.r-lib.org/reference/mw_static.md)
  serves static files from a directory.

- [`mw_text()`](https://webfakes.r-lib.org/reference/mw_text.md) parses
...
[`tmpl_glue()`](https://webfakes.r-lib.org/reference/tmpl_glue.md).
...
- `port`: port to listen on. When `NULL`, the operating system will
  ...
  [how-to](https://webfakes.r-lib.org/reference/how-to.md) manual page
  if you want to start the web server on more than one ports.
