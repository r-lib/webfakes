...
-   Write your own app for your custom test cases; our use app similar to the <https://httpbin.org> API, so if you are writing an HTTP client (httr, curl, crul) you don't need to write your own web app.
